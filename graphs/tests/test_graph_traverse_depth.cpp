...
TEST(GraphTraverseDepth, SingleNode)
{
	...
	traverse_depth(g, 0, f);

	assert_vector_eq(exp_out, out);

}

TEST(GraphTraverseDepth, TreeGraphDirected)
{
...
TEST(GraphTraverseDepth, TreeGraphUndirected)
{
...
TEST(GraphTraverseDepth, StarGraphDirected)
{
...
TEST(GraphTraverseDepth, StarGraphUndirected)
{
...
TEST(GraphTraverseDepth, GeneralDirected)
{
...
TEST(GraphTraverseDepth, GeneralUndirected)
{
